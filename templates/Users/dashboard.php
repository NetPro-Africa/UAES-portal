...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
                                                            <h3 class="page-title">Welcome <?=  ucfirst($user['fname'])?>!</h3>
								<ul class="breadcrumb">
					...
					<div class="row">
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?=$students?></h3>
										<span><?= $this->Html->link('Students', ['controller' => 'Students', 'action' => 'managestudents'], ['title' => 'manage students'])?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?=$applied?></h3>
										<span><?= $this->Html->link('Applicants', ['controller' => 'Students', 'action' => 'manageapplicants'], ['title' => 'manage applicants'])?></span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-suitcase"></i></span>
									<div class="dash-widget-info">
										<h3><?=$alumni?></h3>
										<span>Alumnus</span>
									</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<!--?= $this->Html->image('naira.png', ['alt' => 'Imo State Judiciary', 'style' => 'height: 50px; width: 50px;','class'=>'dash-widget-icon']) ?-->
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3></h3>
										<span><?= $this->Html->link('Transactions', ['controller' => 'Transactions', 'action' => 'index'], ['title' => 'view transactions'])?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?=$admins?></h3>
										<span> <?= $this->Html->link(' Admin', ['controller' => 'Users', 'action' => 'manageadmins'], ['title' => 'manage admins'])?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?=$trequests?></h3>
										<span><?= $this->Html->link('Transcript Requests', ['controller' => 'Admins', 'action' => 'managetranscriptorders'], ['title' => 'manage transcript requests'])?></span>
									</div>
								</div>
							</div>
						</div>
