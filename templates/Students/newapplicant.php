...
?>
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?= $this->Form->control('jambregno', ['label' => 'JAMB Registration Number', 'placeholder' => 'Jamb Regno',
                                          'class' => 'form-control form-control-user2', 'required'])
                                    ?>
                                </div>
                                <div class="col-sm-4 mb-3 mb-sm-0">
                        ...
                        <fieldset><legend><strong>Application Details</strong></legend>
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-4 mb-3 mb-sm-0"> 
                                    ...
                                    <?= $this->Form->control('faculty_id', ['options' => $faculties, 'label' => 'Select School', 'empty' => 'Select School', 'class' => 'form-control form-control-user','onChange'=>'getdepts(this.value)','required']) ?>
                                </div>
                                  <div class="col-sm-4 mb-3 mb-sm-0"> 
...
?>
                            ...
                            <div class="col-sm-4 mb-3 mb-sm-0">               
<?= $this->Form->control('jamb_notifications', ['label' => 'Application Fee Receipt(from REMITA)', 
      'class' => 'form-control form-control-user2', 'type' => 'file'])
?>
                                </div>  
                                 <div class="col-sm-4 mb-3 mb-sm-0">               
