...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Programetype'), ['action' => 'edit', $programetype->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Programetype'), ['action' => 'delete', $programetype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $programetype->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Programetypes'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Programetype'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="programetypes view content">
            <h3><?= h($programetype->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($programetype->students)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($programetype->students as $students) : ?>
                        <tr>
                            <td><?= h($students->id) ?></td>
