            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($state->dstudents as $dstudents) : ?>
                        <tr>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($state->teachers as $teachers) : ?>
                        <tr>
                            <td><?= h($teachers->id) ?></td>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($state->trequests as $trequests) : ?>
                        <tr>
