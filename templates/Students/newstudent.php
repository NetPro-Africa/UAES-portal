                           ...
                           <br />
                                 ...
                                 <div class="col-sm-6 mb-3 mb-sm-0"> 
                                  ...
                                  <div class="col-sm-6 mb-3 mb-sm-0"> 
                                    ...
                                    <?= $this->Form->control('department_id', ['options' => $departments, 'label' => 'Select Department', 'empty' => 'Select Departments', 'class' => 'select2_multiple form-control form-control-user','id'=>'depts','required','onChange'=>'getprogrames(this.value)']) ?>
                                </div>
                            ...
                            <div class="form-group row">
                                 <div class="col-sm-4 mb-3 mb-sm-0"> 
                                    ...
                                    <?= $this->Form->control('programme_id', ['options' => $programes, 'label' => 'Select Programe', 'empty' => 'Select Programe', 'class' => 'form-control form-control-user','required','id'=>'dprogrames']) ?>
                                </div>
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?php
