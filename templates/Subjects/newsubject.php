    ...
    <fieldset>
      <div class="form-group row">
        ...
        <?php
            ...
            <div class="col-sm-4 mb-3 mb-sm-0">
                <?= $this->Form->control('teachers._ids', ['options' => $teachers, 'label' => 'Select Lecturer', 'empty' => 'Select Teacher', 'class' => 'select2_multiple form-control form-control-user']) ?>
        ...
        <?php
            ...
            echo $this->Form->control('level_id',['label' => 'Select Level','options' => $levels, 'placeholder' => 'Select Level', 'required',
                                          'class' => 'form-control form-control-user2']);?>
