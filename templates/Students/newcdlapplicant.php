...
<!--                            <button class="btn btn-info float-right" title="click to check your application status"
                      ...
                      <div class="text-center">
                            ...
                            <h1 class="h4 text-gray-900 mb-4"><?=SCHOOL ?> <br /> Distance Learning Programe Application Form</h1>
                        ...
                        <fieldset><legend><strong>Application Details</strong></legend>
                             <div class="form-group row">
                                   <div class="col-sm-4 mb-3 mb-sm-0"> 
                                    ...
                                    <?= $this->Form->control('faculty_id', ['options' => $faculties, 'label' => 'Select School', 'empty' => 'Select School', 'class' => 'form-control form-control-user','onChange'=>'getdepts(this.value)','default'=>5]) ?>
                                </div>
                                
                                  <div class="col-sm-4 mb-3 mb-sm-0"> 

                                    <?= $this->Form->control('department_id', ['options' => $departments, 'label' => 'Select Course', 'empty' => 'Select Departments', 'class' => 'select2_multiple form-control form-control-user','id'=>'depts','onChange'=>'getprogrames(this.value)']) ?>
                                </div>
                                  <div class="col-sm-4 mb-3 mb-sm-0"> 
                            ...
                            <div class="form-group row">
                                  ...
                                  <div class="col-sm-4 mb-3 mb-sm-0">               
<?= $this->Form->control('olevelresulturls', ['label' => 'Certificate/Others', 'placeholder' => 'cert',
      'class' => 'form-control form-control-user2', 'type' => 'file'])
?>
                                </div>
                                 <div class="col-sm-4 mb-3 mb-sm-0">
...
<br />
<fieldset><legend><strong>Parental Information(For Continuing Education Applicants)</strong></legend>
                            <div class="form-group row">        
                                <div class="col-sm-4 mb-3 mb-sm-0">
...
?>
    ...
    <span style="color: red;">Note: All students MUST own a laptop or desktop computer.</span><br />
...
<script>
 ...
 function getdepts(facultyid){ 
    ...
    $.ajax({
        url: '../Students/getdaptsforcdl/'+facultyid,
        method: 'GET',
        dataType: 'text',
        success: function(response) {
           // console.log(response);
