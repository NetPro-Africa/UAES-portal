...
<?= $this->Form->control('state_id', ['options' => $states, 'label' => 'Select State', 'empty' => 'Select State', 'class' => 'select2_multiple form-control form-control-user', 'multiple' => false,'id'=>'states1','onChange'=>'getlgas(this.value)']) ?>
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?php echo $this->Form->control('lga_id', ['label' => 'Local Government Area', 'options' => $lgas,
                                          'class' => 'select2_multiple form-control', 'required','empty'=>'Select LGA','id'=>'lga'])
                                    ?>
                                </div> 
...
?>
                                 ...
                                 <div class="col-sm-4 mb-3 mb-sm-0"> 
                                    ...
                                    <?= $this->Form->control('programme_id', ['options' => $programes, 'label' => 'Select Programe', 'empty' => 'Select Programe', 'class' => 'form-control form-control-user','required']) ?>
                                </div>
<!--                                <div class="col-sm-4 mb-3 mb-sm-0">
...
?>
                                    ...
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?= $this->Form->control('level_id', ['label' => 'Level', 'placeholder' => 'level',
                                          'class' => 'form-control form-control-user2', 'options' => $levels])
                                    ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">               
<?= $this->Form->control('olevelresulturls', ['label' => 'O\'Level/WAEC/NECO/NABTEB', 'placeholder' => 'olevel cert',
      'class' => 'form-control form-control-user2', 'type' => 'file'])
?>
                                </div>
<!--                                 <div class="col-sm-3 mb-3 mb-sm-0">
                                    <!--?= $this->Form->control('campus_id', ['label' => 'Select Campus', 
                                          'class' => 'form-control form-control-user2', 'options' => $campuses])
                                    ?>
