                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        <h6 class="text-muted"><?=$student->regno  ?></h6>
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                ...
                                                <?= $this->Html->link('', ['controller' => 'Courseregistrations', 'action' => 'view', $course->id,$this->generateurl($course->semester->name)],
    ['title'=>'view registered courses by '.$course->student->fname,'class'=>'pull-right edit-icon fa fa-eye']) ?></span>
                                            </div>
                                        </div>
                                    </li>
                                        <?php }} ?>
