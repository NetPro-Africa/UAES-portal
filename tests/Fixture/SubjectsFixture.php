...
class SubjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subjectcode' => ['type' => 'string', 'length' => 16, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'department_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'creditload' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'subjectcode' => 'Lorem ipsum do',
                'department_id' => 1,
                'creditload' => 1,
                'user_id' => 1,
                'created_date' => 1591780729,
                'status' => 1,
                'semester_id' => 1,
                'level_id' => 1,
            ],
