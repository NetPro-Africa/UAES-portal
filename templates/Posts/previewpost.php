        ...
        <div class="col-md-8">
            <div class="job-info job-widget">
                ...
                <ul class="job-post-det">
                   ...
                   <li><i class="fa fa-eye"></i> Posted By: <span class="text-blue"><?= $post->user->username ?></span></li>
                </ul>
            </div>
                ...
                <div class="chat chat-left">
                    <div class="chat-avatar">
                        <a href="profile.html" class="avatar">
                            <?php
                            if (($comment->user->role_id != 1) || ($comment->user->role_id != 5)) {
                                 $name = $admin->surname;
                                 echo $this->html->image($admin->adminphoto, ['alt' => $admin->surname]);
                             }else{
                            
                          echo  $this->Html->image('../student_files/'.$photo, ['alt' => 'IMG', 'class' => 'avatar',
                             ]);}
                             ?>
                    ...
                    <div class="chat-body">
                        <div class="chat-bubble">
                            <div class="chat-conte">
                                ...
                                <?php
                                 if (($comment->user->role_id != 1) || ($comment->user->role_id != 5)) {
                                 echo  $this->Html->link('Mute', ['controller' => 'Posts', 'action' => 'mutestudent',$student_id, $this->GenerateUrl('mute student')], ['title' => 'mute student']);}
                                 else{ }
                            ?>
                            </div>
                        </div>
