...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $attemptedexamquestion->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $attemptedexamquestion->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="attemptedexamquestions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Attemptedexamquestion') ?></legend>
                <?php
