        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><?= $this->Html->link(' Dashboard', ['controller' => 'Admins', 'action' => 'dashboard'], ['title' => 'students dashboard', 'class' => 'breadcrumb-item']) ?></li>
            ...
            <div class="table-responsive">
                <table class="table table-striped custom-table mb-0 datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?=$count  ?></td>
                            <td><?= $this->Html->link(__($post->title), ['action' => 'previewpost',$post->id,$this->generateurl($post->title)]) ?></td>
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                     ...
                                     echo   $this->Html->link(__(' Close Comments'), ['action' => 'closecomment',$post->id,$this->generateurl($post->title)],['class'=>'dropdown-item fa fa-pencil m-r-5']);}
                                     else{echo   $this->Html->link(__(' Allow Comments'), ['action' => 'allowcomment',$post->id,$this->generateurl($post->title)],['class'=>'dropdown-item fa fa-pencil m-r-5']);}
                                   ?>
                                       <?= $this->Form->postLink(
                __(' Delete'),
