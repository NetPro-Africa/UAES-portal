  ...
  <?php
                ...
                <div class="content container-fluid">
					...
					<!-- /Page Header -->
                                        ...
                                        <div class="row"><div class="col-md-12">Students By Department</div>
                                             <?php foreach($students as $dept) {?>
                                            <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-users"></i></span>
									<div class="dash-widget-info" style="font-size: 8px;">
										<h4><?=$dept->count?> </h4>
										<span><?=$this->getdeptname($dept->department_id)?></span>
									</div>
								</div>
							</div>
						</div>
                                         ...
                                         <div class="row">
                                             <div class="col-md-12">Students By Gender</div>
                                            <?php foreach($bygender as $gender) {?>
                                            <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-users"></i></span>
									<div class="dash-widget-info" style="font-size: 8px;">
										...
										<span><?=$gender->count?> </span>
                                         ...
                                         <div class="row">
                                             <div class="col-md-12">Students By State Of Origin</div>
                                          <?php foreach($bystate as $state) {?>
                                            <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-users"></i></span>
									<div class="dash-widget-info" style="font-size: 8px;">
										<h4><?=$state->count?> </h4>
										<span><?=$this->getstate($state->state_id)?> </span>
									</div>
								</div>
							</div>
						</div>
                                         ...
                                         <div class="row">
                                             <div class="col-md-12">Students By LGA Of Origin</div>
                                         <?php foreach($bylga as $lga) {?>
                                            <div class="col-md-4 col-sm-4 col-lg-4 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									<span class="dash-widget-icon"><i class="fa fa-users"></i></span>
									<div class="dash-widget-info" style="font-size: 8px;">
										<h4><?=$lga->count?> </h4>
										<span><?=$this->getlga($lga->lga_id)?> </span>
									</div>
								</div>
							</div>
						</div>
