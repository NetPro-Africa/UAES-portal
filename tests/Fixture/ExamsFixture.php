...
class ExamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'examname' => ['type' => 'string', 'length' => 444, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'examdate' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'examtime' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'semester_id' => 1,
                'session_id' => 1,
                'examname' => 'Lorem ipsum dolor sit amet',
                'examdate' => 'Lorem ipsum dolor ',
                'examtime' => 'Lorem ipsum dolor ',
                'dateadded' => 1593433301,
                'admin_id' => 1,
            ],
        ];
        parent::init();
