...
<!-- Begin Page Content -->
        <div class="container-fluid">
         ...
         <div style="padding-bottom: 10px; margin-bottom: 20px;"><?= $this->Html->link(__(' '), ['controller'=>'Employees','action' => 'newemployee'],
                            ['class'=>'btn-circle btn-lg fa fa-plus float-right','title'=>'add new employee']) ?>
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Manage Employees</h1></div>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Employees Manager</h6>
            </div>
            <div class="card-body">
  ...
  <?= $this->Form->postLink(__(' Delete'), ['action' => 'delete', $employee->id], ['confirm' => __('Are you sure you want to delete # {0}?', $employee->sname),'class'=>'btn btn-round btn-danger fa fa-times']) ?>
                    <?= $this->Html->link(__(' Pay Slips'), ['controller'=>'Payslips','action' => 'employeepayslips', $employee->id,$this->Generateurl($employee->sname)],['class' => 'btn btn-round btn-info fa fa-eye', 'title' => 'view employee pay slips']) ?>
