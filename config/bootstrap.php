...
//added by chukd - 17/03/2021
define('SCHOOL', 'University of Agriculture and Environmental Sciences Umuagwo');
define('SENDMAIL', 'info@uaes.education');
define('PRETRANS', 'UAES');
define('INVOICEPREFIX', 'UAES');
define('TRANS_REF', 'UAES');
define('REGNOPREFIX', 'UAES');
