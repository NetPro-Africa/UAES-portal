...
?>
           ...
           <?= $this->Form->control('continent_id', ['options' => $continents,'label' => 'Select Continent', 'empty' => 'Select Continent', 'class' => 'form-control form-control-user','onChange'=>'getcountries(this.value)']) ?>
            ...
            <?= $this->Form->control('country_id', ['options' => $countries,'label' => 'Select Country', 'empty' => 'Select Country', 'class' => 'select2_multiple form-control form-control-user','id'=>'country1','onChange'=>'getstates(this.value)']) ?>
                            
             </div>
        
               
                                <div class="col-sm-6 mb-3 mb-sm-0">
           <?= $this->Form->control('state_id', ['options' => $states,'label' => 'Select State', 'empty' => 'Select State', 'class' => 'select2_multiple form-control form-control-user','id'=>'states1']) ?>
